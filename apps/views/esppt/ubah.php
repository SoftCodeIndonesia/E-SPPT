<div class="container">
    <form class="form-horizontal" action="<?= BASE_URL ?>esppt/storeUpdate" method="POST" id="form-create">
        <div class="block">

            <div class="app-heading app-heading-small">
                <div class="title">
                    <h2>Update SPPT Baru</h2>
                    <p>Isi form di bawah ini</p>
                </div>
            </div>
            <input type="hidden" name="sppt_id" value="<?= $helper->uriSegment(0); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <span class="help-block validate_due_date form-error text-danger"></span>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top: 100px">
                ...
                <div class="col-md-10">
                    <input type="text" name="lat" id="lat" class="form-control" placeholder="-74837483743"
                        autocomplete="off">
                    <span class="help-block validate_lat form-error text-danger"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" name="lng" id="lng" class="form-control" placeholder="-74837483743"
                        autocomplete="off">
                    <span class="help-block validate_lng form-error text-danger"></span>
